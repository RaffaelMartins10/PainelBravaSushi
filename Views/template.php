...
<head>
  ...
  <title>Braza Sushi - Painel</title>
...
|---------------------------------------------------------|
-->
<body class="hold-transition skin-blue sidebar-mini" onload="setTimeout('Atualizar()', 300000)">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo BASE_URL; ?>" class="logo">
      ...
      <span class="logo-mini"><b>BS</b>P</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Braza Sushi</b>2.0</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">RM SISTEMAS</a>.</strong> Todos os direitos reservados.
  </footer>
